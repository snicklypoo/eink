...
EPD_WIDTH = 640
EPD_HEIGHT = 384
TODOIST_TOKEN = '712284674a9eb99d15ca524d2556a1c8b85d5a8d'
WEATHER_API = 'a0b8012f442f3167d3e78c128fb5451c'
...
def refresh_Screen():
    ...
    for item in taskList:                            
        temp_draw.text((265, line_start + line_location), projList[item] + ' - ' + item + ' - due: ' + taskList[item], font = font_tasks_list, fill = 0) # Print task strings
        ...
        temp_draw.line((250,line_start + 18 + line_location, 640, line_start + 18 + line_location), fill = 0) # Draw the line below the task
            ...
            #temp_draw.text((602.5, line_start + 3.5 + line_location),str('Today'), font = font_tasks_due_date, fill = 255) # Print the due date of task
        draw_red = temp_draw
